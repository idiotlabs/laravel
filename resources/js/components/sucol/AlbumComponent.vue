<template>
    <b-container>
            ...
            >
                ...
                <div>
                    <transition name="slide-fade">
                        <b-badge
                            v-if="mode == '' && album.songs.length > 0"
                            variant="primary"
                            pill
                            >{{ album.songs.length }}</b-badge
                        >
                    </transition>
                    <transition name="slide-fade">
                        <b-badge
                            ...
                            variant="danger"
                            pill
                            @click="deleteAlbumConfirm(index)"
                        >
                            X
                        </b-badge>
                    </transition>
        ...
        <b-modal v-model="show" size="lg" title="Album detail">
            <b-container fluid>
                <b-row class="my-1">
                    ...
                    <div class="clearfix">
                        <div class="float-right">
                            <b-btn
                                ...
                                size="sm"
                                variant="danger"
                                @click="deleteSong(index, song.id)"
                            >
                                Delete Song
                            </b-btn>
                        </div>
